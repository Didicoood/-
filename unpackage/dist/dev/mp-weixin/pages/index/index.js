...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const canvasBgColor = common_vendor.ref("#ffffff");
    const points = common_vendor.ref([]);
    const penWidth = common_vendor.ref(10);
    const penColor = common_vendor.ref("#666666");
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/uniapp画板/uniapp-drawing-board/pages/index/index.vue"]]);
